const gameData = [
  ...
  },
  {
    ...
    storyModeTwo: `Your task is to add the strings 'ticket' and 'mobile' to the beginning of the array 'bag', so she can use the 'ticket' to commute to her job and the 'mobile' to receive calls during the day.`,
  ...
  },
  {
    ...
    storyModeTwo: `Your task is to remove the string 'ticket' from the array 'bag' and assign it to the variable 'bin'.`,
  ...
  },
  {
    ...
    storyModeTwo: `Your task is to take the strings 'biscuit' and 'apple' from the array 'shelf' and assign it to the variable 'basket'.`,
